...
from function import environment, baseline_models, performance_model, tuned_reward_models
...
study = joblib.load("models/TRPO/merge_in_v3/tuning/run_3/study.pkl")
