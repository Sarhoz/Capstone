...
from highway_env_copy.road.lane import LineType, StraightLane, AbstractLane, lane_from_config
from highway_env_copy.vehicle.objects import Landmark

if TYPE_CHECKING:
    from highway_env_copy.vehicle import kinematics, objects
