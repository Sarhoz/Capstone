...
from highway_env_copy.envs.common.action import ActionType, DiscreteMetaAction, ContinuousAction
from highway_env_copy.road.graphics import WorldSurface, RoadGraphics
from highway_env_copy.vehicle.graphics import VehicleGraphics

if TYPE_CHECKING:
    from highway_env_copy.envs import AbstractEnv
    from highway_env_copy.envs.common.abstract import Action
...
class ObservationGraphics(object):
    ...
    def display(cls, obs, sim_surface):
        from highway_env_copy.envs.common.observation import LidarObservation
