...
def sample_ppo_params(trial: optuna.Trial, expansive:bool=False) -> Dict[str, Any]:
    ...
    learning_rate = trial.suggest_float("learning_rate", 1e-5, 1, log=True)    # default = 3e-4
    ...
    net_arch_type = trial.suggest_categorical("net_arch", ["tiny", "small", "medium"])    # default = 64
